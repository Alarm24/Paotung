...
app.post('/signup',(req,res)=>{
    ...
    cusRef.doc(dat.email).set({email:dat.email , password:dat.password , firstName:dat.firstName , familyName: dat.familyName , token:dat.token , id : dat.id})
})
...
app.post('/createhistory',async(req,res)=>{
  ...
  menu_hist: FieldValue.arrayUnion({restaurant_name:restaurant_name ,menu_name:menu_name , totalPrice:totalPrice , time:time})
});
})
